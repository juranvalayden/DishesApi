...
namespace DishesApi.Infrastructure.Migrations
{
    ...
    [Migration("20260213101440_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DishesApi.Domain.Entities.Dish", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DishesApi.Domain.Entities.Ingredient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DishIngredient", b =>
                {
                    b.HasOne("DishesApi.Domain.Entities.Dish", null)
                        .WithMany()
                        .HasForeignKey("DishesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DishesApi.Domain.Entities.Ingredient", null)
                        .WithMany()
